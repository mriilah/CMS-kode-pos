...
<body>
    ...
    >
      ...
      >
        <amp-img
          src="{{ asset('/asset/img/carikodepos.png') }}"
          width="115"
          height="34"
          layout="fixed"
          class="my0 "
    ...
    >
      ...
      <nav class="ampstart-sidebar-nav logo-img ampstart-nav">
        <ul class="list-reset m0 p0 ampstart-label">
          ...
          <li class="ampstart-nav-item">
            <a class="ampstart-nav-link" href="/"
              >Cari Kodepos</a
            >
          </li>
          <li class="ampstart-nav-item">
      ...
      <h3 class="h7 logo-img block pt3">follow us</h3>
      <ul
        class="ampstart-social-follow logo-img list-reset flex justify-around items-center flex-wrap m0 mb4"
      >
        <li>
          <a
      ...
      <ul class="ampstart-sidebar-faq logo-img list-reset m0">
